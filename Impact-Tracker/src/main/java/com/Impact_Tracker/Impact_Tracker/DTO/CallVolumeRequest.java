...
public class CallVolumeRequest {
    ...
    public void setAnswered(List<Integer> answered) { this.answered = answered; }

    public List<Integer> getMissed() { return missed; }
    public void setMissed(List<Integer> missed) { this.missed = missed; }

    public List<Integer> getVoicemail() { return voicemail; }
    public void setVoicemail(List<Integer> voicemail) { this.voicemail = voicemail; }

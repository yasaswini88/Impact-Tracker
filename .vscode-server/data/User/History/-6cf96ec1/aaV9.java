...
public class EndUserNotificationService {
    ...
    private String buildEmailHtml(Appointment appointment, WeatherForecast wf) {
        ...
        return "<html><body>"
                ...
                + "<p>"
                + "<a href='http://52.3.145.159:8080/api/v1/end-user/appointment-yes?appointmentId=" + appointmentId
                   + "&customerId=" + customerId
                   + "&businessId=" + businessId
                   + "'>YES, reschedule</a><br>"
                + "<a href='http://52.3.145.159:8080/api/v1/end-user/appointment-no?appointmentId=" + appointmentId
                   + "&customerId=" + customerId
                   + "&businessId=" + businessId
